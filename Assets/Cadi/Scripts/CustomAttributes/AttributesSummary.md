# Cadi Custom Attributes — Developer Summary

A collection of Unity inspector attributes that make the Inspector more useful without any extra setup. Just add the attribute to your field or method.

---

## [Button] — Run methods from the Inspector
